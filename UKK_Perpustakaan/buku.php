          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="buku_tambah.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah Buku</a>
                                ...
                                <?php
                                    ...
                                    while($data = mysqli_fetch_array($query)){
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="assets/img/<?php echo $data['foto']; ?>" class="card-img-top" ></td>
                                            <td>
                                                <a href="buku_ubah.php?id=<?php echo $data['bukuID']; ?>" class="btn btn-info">Ubah</a>
                                                <a onclick="return confirm('ANDA YAKIN INGIN HAPUS BUKU INI?');" href="buku_hapus.php?id=<?php echo $data['bukuID']; ?>" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
