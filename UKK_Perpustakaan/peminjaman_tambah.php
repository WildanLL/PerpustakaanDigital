  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      ...
      <?php
        ...
        ?>
      <li class="nav-item">
        <a class="nav-link collapsed" href="daftar_buku.php">
          <i class="fas fa-book"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="favorit.php">
          <i class="fas fa-bookmark"></i>
          <span>Favorite Buku</span>
        </a>
      </li>
      <?php
        }
      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="card">
              ...
              <div class="row">
                  <div class="col-md-12">
                      <form method="post" action="aksi/aksi_peminjaman_tambah.php">
                      <div class="row mb-3">
                                ...
                                <?php
                                  $id = $_GET['id'];
                                    ...
                                    while($buku = mysqli_fetch_array($buk)){
                                        ?>
                                  <input type="hidden" class="form-control" name="buku" value="<?php echo $buku['bukuID'];?>">
                                  <input type="text" class="form-control" name="buku" value= "<?php echo $buku['judul'];?>" disabled>
                                  <?php
                                    }  
                                    ?>
                              </div>
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-md-8"><input type="number" class="form-control" name="jumlah" max="2" min="1" value="1"></div>
                          </div>
                          <div class="row mb-3">
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-8">
                                  ...
                                  <a href="daftar_buku.php" class="btn btn-danger">Kembali</a>
                              </div>
                          </div>
                      </form>
                  </div>
