      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Favorit Buku</h1>
          </div>
          <div class="card">
              <div class="card-body">
                  <div class="row">
                      <div class="col-md-12">
                        <div class="row m-4">
                          <?php
                            ...
                            $query = mysqli_query($koneksi, "SELECT*FROM koleksipribadi JOIN user on user.userID=koleksipribadi.userID JOIN buku on buku.bukuID = koleksipribadi.bukuID");
                          ...
                          <div class="card m-4 " style="width: 14rem;">
                            ...
                            <div class="card-body">
                              ...
                              <a href="aksi/aksi_hapus_favorit.php?koleksiID=<?php echo $data['koleksiID']; ?>" class="btn btn-dark">Hapus Favorit</a>
                            </div>
                          </div>
                          <?php
                            }
