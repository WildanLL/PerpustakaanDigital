      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Kembalikan Buku</h1>
          </div>
          <div class="card">
              <div class="card-body">
              <div class="row">
                      ...
                      <form method="post">
                          ...
                          <?php
                              ...
                              if(isset($_POST['submit'])){
                                  ...
                                  $status = $_POST['status'];
                                  $query = mysqli_query($koneksi, "UPDATE peminjaman SET bukuIDFA='$bukuID', tanggal_peminjaman='$tanggal_peminjaman', tanggal_pengembalian='$tanggal_pengembalian', status='$status' WHERE peminjamanID=$id");

                                  if($query){
                                      echo '<script>alert("UBAH DATA BERHASIL.");location.href="detail_pinjam.php";</script>';
                                  }else{
                                  ...
                                  <select name="bukuID" class="form-control">
                                      <?php
                                          ...
                                          while($buku = mysqli_fetch_array($buk)){
                                              ?>
                                              <option <?php if($buku['bukuID'] == $data['bukuIDFA']) echo 'selected'; ?> value="<?php echo $buku['bukuID'];?>" readonly><?php echo $buku['judul'];?></option>
                                              <?php
                                          }  
                                      ?>
                                  </select>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-8">
                                  ...
                                  <a href="detail_pinjam.php" class="btn btn-danger">Kembali</a>
                              </div>
                          </div>
                      </form>
                  </div>
