              ...
              <div class="card-body">
                  <div class="row">
                      ...
                      <?php
                          if($_SESSION['user']['level'] == 'peminjam'){
                        ?>
                          <a href="ulasan_tambah.php" class="btn btn-primary mb-3"><i class="fa fa-plus"></i> Tambah Ulasan</a>
                          <?php
                          }
                          ?>
                          <table class="table table-flush" id="dataTable" width="100%" cellspacing="0">
                              ...
                              <?php
                                  ...
                                  $query = mysqli_query($koneksi, "SELECT*FROM ulasan LEFT JOIN user ON user.userID = ulasan.userID LEFT JOIN buku ON buku.bukuID = ulasan.bukuID");
                                  while($data = mysqli_fetch_array($query)){
                                      ...
                                      <tr>
                                          ...
                                          <?php
                                           ...
                                           ?>
                                          <td>
                                              <a href="ulasan_hapus.php?id=<?php echo $data['ulasanID']; ?>" onclick="return confirm('Yakin Ingin Dihapus?')" class="btn btn-danger">Hapus</a>
                                          </td>
                                          <?php
                                              }
                                          ?>
