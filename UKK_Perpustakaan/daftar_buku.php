                      ...
                      <div class="col-md-12">
                        <div class="row m-4">
                          <?php
                            ...
                            $query = mysqli_query($koneksi, "SELECT * FROM buku order by bukuID asc");
                          ...
                          <div class="card m-4 " style="width: 14rem;">
                            ...
                            <div class="card-body">
                              ...
                              <a href="detail.php?id=<?php echo $data['bukuID']; ?>" class="btn btn-primary">Detail</a>
                              <a href="peminjaman_tambah.php?id=<?php echo $data['bukuID']; ?>" class="btn btn-success">Pinjam</a>
                              <a href="aksi/aksi_favorit.php?bukuID=<?php echo $data['bukuID']; ?>" class="btn btn-outline-dark" style="width: 18%;"><i class="fas fa-bookmark"></i></a>
                            </div>
                          </div>
                          <?php
                            }
