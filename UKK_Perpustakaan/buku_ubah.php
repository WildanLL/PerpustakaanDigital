                  ...
                  <div class="col-md-12">
                      ...
                      <?php
                          ...
                          if(isset($_POST['submit'])){
                              ...
                              $stok = $_POST['stok'];
                              $foto = $_POST['foto'];
                              $query = mysqli_query($koneksi, "UPDATE buku SET kategoriID = '$kategoriID', judul = '$judul', penulis = '$penulis', penerbit = '$penerbit', tahun_terbit = '$tahun_terbit', deskripsi = '$deskripsi', stok = '$stok', foto = '$foto' WHERE bukuID = $id");

                              if($query){
                                  echo '<script>alert("UBAH BUKU BERHASIL.");location.href="buku.php";</script>';
                              }else{
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-md-8">
                                  <select name="kategori" class="form-control">
                                      <?php
                                          $kateg= mysqli_query($koneksi, "SELECT*FROM kategoribuku");
