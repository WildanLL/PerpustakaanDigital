                      ...
                      <form method="post">
                          ...
                          <?php
                              ...
                              if(isset($_POST['submit'])){
                                  ...
                                  $query = mysqli_query($koneksi, "UPDATE kategoribuku set nama_kategori='$kategori' WHERE kategoriID=$id");
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-md-8"><input type="text" class="form-control" value="<?php echo $data['nama_kategori']; ?>" name="kategoribuku"></div>
                          </div>
                          <div class="row">
