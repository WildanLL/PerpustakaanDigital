                      ...
                      <div class="col-md-12">
                          <table class="table table-flush" id="dataTable" width="100%" cellspacing="0">
                              ...
                              <?php
                                  ...
                                  $query = mysqli_query($koneksi, "SELECT*FROM peminjaman LEFT JOIN user ON user.userID = peminjaman.userID LEFT JOIN buku ON buku.bukuID = peminjaman.bukuIDFA WHERE peminjaman.userID=".$_SESSION['user']['userID']);
